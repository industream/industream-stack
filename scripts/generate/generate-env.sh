...
echo "# ============================================"
echo "KEYCLOAK_ADMIN=$(get_or_default 'KEYCLOAK_ADMIN' 'admin')"
echo "KEYCLOAK_ADMIN_PASSWORD=$(get_or_generate_password 'KEYCLOAK_ADMIN_PASSWORD')"
echo "KC_DB_PASSWORD=$(get_or_generate_password 'KC_DB_PASSWORD')"
echo ""
echo "# ============================================"
...
echo "# ============================================"
echo "FLOWMAKER_CORE_VERSION=$(get_or_default 'FLOWMAKER_CORE_VERSION' '1.7.4')"
echo "FLOWMAKER_FRONTEND_VERSION=$(get_or_default 'FLOWMAKER_FRONTEND_VERSION' '1.7.4')"
echo "FLOWMAKER_BOX_VERSION=$(get_or_default 'FLOWMAKER_BOX_VERSION' '2.0.3')"
echo "FLOWMAKER_TOOLKIT_VERSION=$(get_or_default 'FLOWMAKER_TOOLKIT_VERSION' '1.10.1')"
echo "FLOWMAKER_SCHEDULER_ID=$(generate_scheduler_id)"
echo ""
echo "# ============================================"
echo "# UIMaker Configuration"
echo "# ============================================"
echo "UIMAKER_VERSION=$(get_or_default 'UIMAKER_VERSION' '1.2.21')"
echo ""
echo "# ============================================"
